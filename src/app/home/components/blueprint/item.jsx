...
export default function Index() {
  ...
  const [activeImageId, setActiveImageId] = useState("blueprint_5");
  ...
  return (
    <div className='two-col'>
      {/* blueprint_2 */}
      <div className={`description-container ${activeImageId === "blueprint_2" ? "active" : ''}`}>
        <div className='description'>
          <h3 className='sub-title blue'><Description>VISION</Description> </h3>
      ...
      {/* blueprint_3 */}
      <div className={`description-container ${activeImageId === "blueprint_3" ? "active" : ''}`}>
        <div className='description'>
          <h3 className='sub-title blue'><Description>PURPOSE</Description> </h3>
      ...
      {/* blueprint_4 */}
      <div className={`description-container ${activeImageId === "blueprint_4" ? "active" : ''}`}>
        <div className='description'>
          <h3 className='sub-title blue'><Description>CORPORATE VALUES</Description> </h3>
          ...
          <div className='blueprint-list'>
            <div className='blueprint-item'>
              ...
              <div className='info'>
                <span className='label'>
                  <b className='blue'>Excellence</b>
                </span>
                <div className='text'>
                  <p>We believe in doing our best</p>
                  <p>We think innovation</p>
                  <p>We help our people succeed</p>
                </div>
              </div>
            </div>
            ...
            <div className='blueprint-item'>
              ...
              <div className='info'>
                <span className='label'>
                  <b className='orange'>Accountability</b>
                </span>
                <div className='text'>
                  <p>We do what is right</p>
                  <p>We take accountability for our decisions</p>
                </div>
              </div>
            </div>
            ...
            <div className='blueprint-item'>
              ...
              <div className='info'>
                <span className='label'>
                  <b className='green'>Sustainability</b>
                </span>
                <div className='text'>
                  <p>We are a good neighbor</p>
                  <p>We advocate sustainable development</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* blueprint_5 */}
      <div className={`description-container ${activeImageId === "blueprint_5" ? "active" : ''}`}>
        <div className='description'>

          <h3 className='sub-title green'><Description>A World of Good: Our Sustainability Agenda</Description> </h3>
          ...
          <div className='goals'>
            <p><b>Our Sustainability Goals</b></p>
            ...
            <p>4. A fully sustainable and ethical supply chain by 2040</p>
          </div>
        </div>
      </div>

      {/* blueprint_6 */}
      <div className={`description-container ${activeImageId === "blueprint_6" ? "active" : ''}`}>
        <div className='description'>
          <h3 className='sub-title orange'><Description>OUR BUSINESSES</Description> </h3>
          <div className='our-business'>
            <div className='business-item'>
              <Image src="SMB.svg" width={100} height={77} alt='SMBI' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="GSM.svg" width={100} height={67} alt='GSM' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="SMCF.svg" width={100} height={58} alt='SMCF' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="yamamura2.svg" width={100} height={40} alt='SMYPC' quality={75} />
            </div>
            <div className='business-item'>
              <Image className='blend-multiply' src="PETRON.svg" width={72} height={110} alt='PETRON' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="SMGP.svg" width={100} height={40} alt='SMGP' quality={75} />
            </div>
            <div className='business-item p-5'>
              <Image className='blend-multiply' src="SMCI.svg" width={146} height={30} alt='SMCI' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="NCC.svg" width={100} height={76} alt='NCC' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="ECC.svg" width={98} height={46} alt='ECC' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="SMP.svg" width={110} height={58} alt='SMP' quality={75} />
            </div>
            <div className='business-item'>
              <Image src="BankComAffilliate.svg" width={98} height={101} alt='BankComAffilliate' quality={75} />
            </div>
          </div>
        </div>
      </div>
      ...
      <motion.div ref={ref}
        ...
        <div className='img-item' >
          <motion.span
            ...
            transition={{ delay: 1.65, duration: .5 }}  >
            <Image style={{ marginLeft: '30px' }} src="smc_logo_white.svg" width={62} height={73} alt='SMC LOGO - WHITE' />
          </motion.span>
          ...
          >
            <Image className={`image ${activeImageId === "blueprint_1" ? 'active' : ''}`} src='b_1.svg' alt="A Blueprint for San Miguel 1" width={209} height={100} />
          </motion.div>
        </div>

        <div className='img-item' onClick={() => handleClick("blueprint_2")}>
          ...
          <motion.div
            ...
            <div className="circle pulse">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 448 512">
                <path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" fill="#ffff" />
              </svg>
            </div>
          </motion.div>
          ...
          >
            ...
            <Image className={`image ${activeImageId === "blueprint_2" ? 'active' : ''}`} src='b_2.svg' alt="A Blueprint for San Miguel 2" width={291} height={100} />
          </motion.div>
        </div>

        <div className='img-item' onClick={() => handleClick("blueprint_3")}>
          <motion.div
            variants={variants3}
            initial="initial"
            animate={isInView ? "animate" : "exit"}
          ...
          >
            <Image className={`image ${activeImageId === "blueprint_3" ? 'active' : ''}`} src='b_3.svg' alt="A Blueprint for San Miguel 3" width={365} height={100} />
          </motion.div>
        </div>


        <div className='img-item' onClick={() => handleClick("blueprint_4")}>
          <motion.div
            variants={variants3}
            initial="initial"
            animate={isInView ? "animate" : "exit"}
          ...
          >   <Image className={`image ${activeImageId === "blueprint_4" ? 'active' : ''}`} src='b_4.svg' alt="A Blueprint for San Miguel 4" width={441} height={100} />
          </motion.div>
        </div>


        <div className='img-item' onClick={() => handleClick("blueprint_5")}>
          <motion.div
            variants={variants3}
            initial="initial"
            animate={isInView ? "animate" : "exit"}
          ...
          >
            <Image className={`image ${activeImageId === "blueprint_5" ? 'active' : ''}`} src='b_5.svg' alt="A Blueprint for San Miguel 5" width={510} height={100} />
          </motion.div>
        </div>

        <div className='img-item' onClick={() => handleClick("blueprint_6")}>
          <motion.div
            variants={variants3}
            initial="initial"
            animate={isInView ? "animate" : "exit"}
          ...
          >
            <Image className={`image ${activeImageId === "blueprint_6" ? 'active' : ''}`} src='b_6.svg' alt="A Blueprint for San Miguel 6" width={550} height={100} />
          </motion.div>
        </div>
