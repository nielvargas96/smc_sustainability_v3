    ...
    <div className="wrap-item kalinga"  >
      ...
      <motion.svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        <motion.path
          ...
          d="M100 200C155.228 200 200 155.228 200 100C200 44.7717 155.228 0 100 0C44.7717 0 0 44.7717 0 100C0 155.228 44.7717 200 100 200Z" fill="#f3813bd9" />
    ...
    <div className="wrap-item kalikasan">
      ...
      <motion.svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <motion.path
          variants={variants_4}
          animate={isInView ? "open" : "closed"}
          d="M100 200C155.228 200 200 155.228 200 100C200 44.7717 155.228 0 100 0C44.7717 0 0 44.7717 0 100C0 155.228 44.7717 200 100 200Z" fill="#55b047d9" />
    ...
    <div className="wrap-item kasaganahan">
      ...
      <motion.svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        <motion.path
          variants={variants_4}
          animate={isInView ? "open" : "closed"}
          d="M100 200C155.228 200 200 155.228 200 100C200 44.7717 155.228 0 100 0C44.7718 0 0 44.7717 0 100C0 155.228 44.7718 200 100 200Z" fill="#00a3d5d9" />
